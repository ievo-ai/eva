...
- **Commit & PR authorship**: Eva signs all commits and PRs with her identity. When Eva is co-author: `Co-Authored-By: iEVO Eva 4.6 <noreply@ievo.ai>`. When Eva is the sole author (automated mutations, self-evolution): `Author: iEVO Eva 4.6 <noreply@ievo.ai>`. Same signature goes in PR descriptions. This replaces any generic `Co-Authored-By` lines.
